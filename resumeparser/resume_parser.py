...
class ResumeParser(object):
    ...
    def __get_basic_details(self):
        ...
        edus = utils.extract_year(
            [sent.string.strip() for sent in self.__nlp.sents])
        experience = utils.extract_experience(self.__text)
        experiences = utils.extract_exp_year(self.__text)
        ...
        self.__details['educations'] = edus
        self.__details['experience'] = experience
        try:
            self.__details['experiences'] = experiences
        except KeyError:
            self.__details['experiences'] = 0
        return
